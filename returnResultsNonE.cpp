...
void returnResultsNonE(Int_t runNumber, Double_t nonE_effThreshold){
    ...
    FindAllRejectionRateWithEfficiency(graph, graph_OP, nonE_effThreshold, runNumber, momentum, outputFile);

    outputFile.close();
    Draw2500PointWithResults(graph, graph_OP, momentum, "wIntCharge", nonE_effThreshold, false);
